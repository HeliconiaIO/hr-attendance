...
class TestHrAttendanceReason(BaseCommon):
    ...
    def test_employee_edit(self):
        # We use a fixed Wednesday to ensure lunch break is deducted correctly.
        # 2024-01-10 was a Wednesday. Yesterday was Tuesday, no holidays.
        now_dt = datetime(2024, 1, 10, 9, 0, 0)
        dti = now_dt
